...
local function mkWarn(parent,txt,yPos)
    ...
    warn.Size=UDim2.new(1,-10,0,25);warn.Position=UDim2.new(0,5,0,yPos)
...
local function init()
    ...
    RunSvc.Heartbeat:Connect(function()
        ...
        if THEMES[cTheme].rb then
            ...
            -- Update colors dynamically would go here, but for performance we keep it simple
        end
        -- Run Features
        if _G.ESP then updSk() end -- ESP logic loop
    end)
end
