...
crosshairGui = makeScreenGui("NoraCH", 200)
...
fovGui = makeScreenGui("NoraFOV", 200)
...
tpIndicatorGui = makeScreenGui("NoraTPInd", 198)
...
killFeedGui = makeScreenGui("NoraKillFeed", 150)
...
gameSenseGui = makeScreenGui("NoraGameSense", 150)
...
chatLoggerGui = makeScreenGui("NoraChatLog", 100)
...
title.Text = "[CHAT] Chat Log - Nora"; title.TextColor3 = Color3.new(1,1,1)
...
miniMapGui = makeScreenGui("NoraMiniMap", 150); miniMapDots = {}
size = 180
...
task.spawn(function()
local notifGui = makeScreenGui("NoraKeybindNotif", 9997)
...
espBuilderGui = makeScreenGui("NoraESPBuilder", 8500)
local W, H = 480, 600
...
watermarkGui = makeScreenGui("NoraWatermark", 9998)
...
txt.Text = "NORA v2.2  |  " .. USERNAME .. "  |  .gg/tCufFEMdux"
...
MainGui = makeScreenGui("NoraUI", 9999); MainGui.Enabled = true
Tc = makeThemeColors()
...
logoTxt.BackgroundTransparency = 1; logoTxt.Text = "NORA"
