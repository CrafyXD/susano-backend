...
-- Dil sistemi
local LANG = "TR" -- TR veya EN
local L = {
    TR = {
        key_title="Anahtarını gir", key_enter="ANAHTAR", key_placeholder="SUSANO-XXXX-XXXXXXXX",
        key_btn="GİRİŞ YAP", key_checking="KONTROL EDİLİYOR…", key_remember="Bu cihazda anahtarı hatırla",
        key_valid="Geçerli anahtar!", key_invalid="Geçersiz anahtar", key_expired="Süresi dolmuş",
        key_other_device="Başka cihaza bağlı", key_server_err="Sunucuya bağlanılamadı",
        key_too_many="Çok fazla yanlış deneme.", key_enter_key="Anahtar gir.",
        key_footer="Susano V1.0  |  Discord'dan key al",
        type_daily="GÜNLÜK", type_weekly="HAFTALIK", type_monthly="AYLIK", type_lifetime="SINIRSIZ",
        time_unlimited="SINIRSIZ", time_expired="SÜRESİ DOLDU", time_left_d="g ", time_left_h="s ", time_left_m="dk kaldı",
        tab_esp="ESP", tab_aimbot="Aimbot", tab_move="Hareket", tab_players="Oyuncular",
        tab_item="Eşya", tab_team="Takım", tab_visual="Görsel", tab_config="Config", tab_about="Hakkında",
        esp_active="ESP Aktif", esp_3d="3D Vurgu", esp_2d="2D Kutu", esp_skel="İskelet ESP",
        esp_names="İsim", esp_dist="Mesafe", esp_health="Can Çubuğu", esp_id="ID", esp_tracer="Tracer",
        esp_tracer_thick="Tracer Kalınlık", esp_team_check="Düşmanları Göster", esp_friendly="Takım Arkadaşları",
        esp_wall="Duvar Kontrolü (Chams)", esp_enemy_col="Düşman Rengi", esp_friend_col="Dost Rengi",
        esp_visible_col="Görünür Renk (Yeşil=Görünür)", esp_crosshair="Nişangah", esp_style="Stil",
        esp_size="Boyut", esp_thick="Kalınlık", esp_gap="Boşluk", esp_opacity="Opaklık",
        esp_dot="Merkez Nokta", esp_outline="Dış Çizgi", esp_ch_col="Nişangah Rengi",
        aim_aimbot="Aimbot", aim_rage="Rage Aimbot", aim_silent="Silent Aim",
        aim_fov_filter="FOV Filtresi", aim_fov_circle="FOV Dairesi", aim_fov_size="FOV Çapı",
        aim_smooth="Yumuşaklık", aim_head="Kafa", aim_chest="Göğüs", aim_stomach="Karın",
        move_fly="Uç", move_fly_speed="Uçuş Hızı", move_noclip="Noclip",
        move_inf_jump="Sonsuz Zıplama", move_long_jump="Uzun Atlama", move_jump_power="Atlama Gücü",
        move_swim="Yüzme Hack", move_bhop="Bunny Hop", move_bhop_speed="Hız",
        move_speed="Hız Hack", move_speed_mult="Çarpan", move_stream="Stream Proof",
        play_kill_aura="Kill Aura", play_range="Menzil", play_anti_afk="Anti AFK",
        play_name_spoof="İsim Değiştir", play_fake_name="Sahte İsim", play_apply="Uygula",
        play_stop_spec="İzlemeyi Durdur", play_list="Oyuncu Listesi",
        vis_fullbright="Full Bright", vis_nofog="Sis Kaldır", vis_fov="FOV Değiştir",
        vis_fov_val="FOV Değeri", vis_3rdperson="3. Şahıs", vis_dist="Mesafe",
        vis_time="Saat Değiştir", vis_time_val="Saat (0-23)", vis_world_col="Renk Değiştir",
        vis_red="Kırmızı", vis_green="Yeşil", vis_blue="Mavi", vis_preview="Renk Önizleme",
        cfg_info="Config kaydet → Gist ID al → Paylaş", cfg_save="Config Kaydet",
        cfg_name="Config Adı", cfg_save_btn="Gist'e Kaydet", cfg_saving="Kaydediliyor...",
        cfg_load="Config Yükle", cfg_gist_id="Gist ID", cfg_load_btn="Yükle",
        cfg_saved="Kayıtlılar", cfg_no_config="Henüz config yok.",
        cfg_saved_ok="Kaydedildi!\nKod: ", cfg_load_ok="Yüklendi!", cfg_fail="Başarısız.",
        lang_btn="🌐 EN",
        sec_visibility="Görünürlük", sec_labels="Etiketler", sec_filters="Filtreler",
        sec_aimbot="Aimbot", sec_silent="Silent Aim", sec_fov="FOV", sec_smooth="Yumuşaklık",
        sec_target="Hedef", sec_fly="Uçuş", sec_move="Hareket", sec_bhop="Bunny Hop",
        sec_speed="Hız", sec_other="Diğer", sec_combat="Savaş", sec_helper="Yardımcı",
        sec_spoof="İsim Spoofing", sec_lighting="Aydınlatma", sec_camera="Kamera",
        sec_world="Dünya", sec_world_col="Dünya Rengi",
        about_shortcut="F5 — Menü Aç/Kapat",
        about_key="GitHub Private Repo. HWID kilitleme.",
        about_config="Gist ID ile paylaş.",
        about_esp="ESP, Aimbot, Silent Aim, Fly, Noclip, Speed, BunnyHop, Kill Aura, Anti AFK, Name Spoof, Full Bright, No Fog, FOV Changer, 3rd Person, Time Changer, World Color, Skeleton ESP, 2D/3D ESP, Tracer, Crosshair, Config Sistemi",
        about_gui="PlayerGui — Xeno uyumlu.",
    },
    EN = {
        key_title="Enter your key", key_enter="KEY", key_placeholder="SUSANO-XXXX-XXXXXXXX",
        key_btn="LOGIN", key_checking="CHECKING…", key_remember="Remember key on this device",
        key_valid="Valid key!", key_invalid="Invalid key", key_expired="Key expired",
        key_other_device="Key bound to another device", key_server_err="Could not connect to server",
        key_too_many="Too many wrong attempts.", key_enter_key="Enter key.",
        key_footer="Susano V1.0  |  Get key from Discord",
        type_daily="DAILY", type_weekly="WEEKLY", type_monthly="MONTHLY", type_lifetime="LIFETIME",
        time_unlimited="UNLIMITED", time_expired="EXPIRED", time_left_d="d ", time_left_h="h ", time_left_m="m left",
        tab_esp="ESP", tab_aimbot="Aimbot", tab_move="Movement", tab_players="Players",
        tab_item="Items", tab_team="Team", tab_visual="Visual", tab_config="Config", tab_about="About",
        esp_active="ESP Active", esp_3d="3D Highlight", esp_2d="2D Box", esp_skel="Skeleton ESP",
        esp_names="Names", esp_dist="Distance", esp_health="Health Bar", esp_id="ID", esp_tracer="Tracer",
        esp_tracer_thick="Tracer Thickness", esp_team_check="Show Enemies", esp_friendly="Teammates",
        esp_wall="Wall Check (Chams)", esp_enemy_col="Enemy Color", esp_friend_col="Friend Color",
        esp_visible_col="Visible Color (Green=Visible)", esp_crosshair="Crosshair", esp_style="Style",
        esp_size="Size", esp_thick="Thickness", esp_gap="Gap", esp_opacity="Opacity",
        esp_dot="Center Dot", esp_outline="Outline", esp_ch_col="Crosshair Color",
        aim_aimbot="Aimbot", aim_rage="Rage Aimbot", aim_silent="Silent Aim",
        aim_fov_filter="FOV Filter", aim_fov_circle="FOV Circle", aim_fov_size="FOV Size",
        aim_smooth="Smoothness", aim_head="Head", aim_chest="Chest", aim_stomach="Stomach",
        move_fly="Fly", move_fly_speed="Fly Speed", move_noclip="Noclip",
        move_inf_jump="Infinite Jump", move_long_jump="Long Jump", move_jump_power="Jump Power",
        move_swim="Swim Hack", move_bhop="Bunny Hop", move_bhop_speed="Speed",
        move_speed="Speed Hack", move_speed_mult="Multiplier", move_stream="Stream Proof",
        play_kill_aura="Kill Aura", play_range="Range", play_anti_afk="Anti AFK",
        play_name_spoof="Name Spoof", play_fake_name="Fake Name", play_apply="Apply",
        play_stop_spec="Stop Spectating", play_list="Player List",
        vis_fullbright="Full Bright", vis_nofog="Remove Fog", vis_fov="FOV Changer",
        vis_fov_val="FOV Value", vis_3rdperson="3rd Person", vis_dist="Distance",
        vis_time="Time Changer", vis_time_val="Time (0-23)", vis_world_col="Change Color",
        vis_red="Red", vis_green="Green", vis_blue="Blue", vis_preview="Color Preview",
        cfg_info="Save config → Get Gist ID → Share", cfg_save="Save Config",
        cfg_name="Config Name", cfg_save_btn="Save to Gist", cfg_saving="Saving...",
        cfg_load="Load Config", cfg_gist_id="Gist ID", cfg_load_btn="Load",
        cfg_saved="Saved Configs", cfg_no_config="No configs yet.",
        cfg_saved_ok="Saved!\nCode: ", cfg_load_ok="Loaded!", cfg_fail="Failed.",
        lang_btn="🌐 TR",
        ...
        sec_speed="Speed", sec_other="Other", sec_combat="Combat", sec_helper="Helper",
        sec_spoof="Name Spoof", sec_lighting="Lighting", sec_camera="Camera",
        sec_world="World", sec_world_col="World Color",
        about_shortcut="F5 — Open/Close Menu",
        about_key="GitHub Private Repo. HWID lock.",
        about_config="Share via Gist ID.",
        about_esp="ESP, Aimbot, Silent Aim, Fly, Noclip, Speed, BunnyHop, Kill Aura, Anti AFK, Name Spoof, Full Bright, No Fog, FOV Changer, 3rd Person, Time Changer, World Color, Skeleton ESP, 2D/3D ESP, Tracer, Crosshair, Config System",
        about_gui="PlayerGui — Xeno compatible.",
    }
}
...
local function httpGet(url, headers)
    local ok,resp=pcall(function()
        return (http_request or request)({Url=url,Method="GET",Headers=headers or {}})
    end)
...
local function httpPost(url, body, headers)
    local ok,resp=pcall(function()
        return (http_request or request)({Url=url,Method="POST",Headers=headers or {},Body=body})
    end)
    if not ok or not resp then return false,nil end
    return true,(resp.Body or resp.body)
end

local function httpPut(url, body, headers)
    local ok,resp=pcall(function()
        return (http_request or request)({Url=url,Method="PUT",Headers=headers or {},Body=body})
    end)
    if not ok or not resp then return false,nil end
    return true,(resp.Body or resp.body)
end
...
local function httpDelete(url, headers)
    local ok,resp=pcall(function()
        return (http_request or request)({Url=url,Method="DELETE",Headers=headers or {}})
    end)
    return ok and resp
end
...
local function githubWrite(path,content,message)
    ...
    local currentSHA=""
    local ok2,shaBody=httpGet(shaUrl,{["Authorization"]="token "..CFG.GITHUB_TOKEN,["Accept"]="application/vnd.github.v3+json",["User-Agent"]="Susano"})
    if ok2 and shaBody then
        local ok3,data=pcall(function() return HttpService:JSONDecode(shaBody) end)
        if ok3 and data and data.sha then currentSHA=data.sha end
    end
    ...
    local bodyStr=HttpService:JSONEncode({message=message or "update",content=encode(content),sha=currentSHA~="" and currentSHA or nil,branch=CFG.GITHUB_BRANCH})
    return httpPut(shaUrl,bodyStr,{["Authorization"]="token "..CFG.GITHUB_TOKEN,["Accept"]="application/vnd.github.v3+json",["Content-Type"]="application/json",["User-Agent"]="Susano"})
end

local function gistCreate(name,content)
    local bodyStr=HttpService:JSONEncode({description="Susano: "..name,public=false,files={[name..".json"]={content=content}}})
    local ok,resp=httpPost("https://api.github.com/gists",bodyStr,{["Authorization"]="token "..CFG.GIST_TOKEN,["Accept"]="application/vnd.github.v3+json",["Content-Type"]="application/json",["User-Agent"]="Susano"})
    if not ok or not resp then return false,nil end
...
local function gistRead(id)
    local ok,resp=httpGet("https://api.github.com/gists/"..id,{["Authorization"]="token "..CFG.GIST_TOKEN,["Accept"]="application/vnd.github.v3+json",["User-Agent"]="Susano"})
    if not ok or not resp then return false,nil end
    local ok2,data=pcall(function() return HttpService:JSONDecode(resp) end)
...
local function gistDelete(id)
    return httpDelete("https://api.github.com/gists/"..id,{["Authorization"]="token "..CFG.GIST_TOKEN,["User-Agent"]="Susano"})
end
...
local function formatTimeLeft(exp)
    ...
    if d>0 then return d..T("time_left_d")..h..T("time_left_h")..T("time_left_m")
    elseif h>0 then return h..T("time_left_h")..m..T("time_left_m")
    else return m..T("time_left_m") end
end
...
local function validateKey(key,callback)
    ...
    task.spawn(function()
        ...
        if not kd then callback(false,T("key_invalid"),0);return end
        if kd.expires and kd.expires>0 and os.time()>kd.expires then callback(false,T("key_expired"),0);return end
        if kd.hwid and kd.hwid~="" and kd.hwid~="null" and kd.hwid~=nil then
            if tostring(kd.hwid)~=HWID then callback(false,T("key_other_device"),0);return end
        else
...
local Tc={BG=Color3.fromRGB(12,12,12),Sidebar=Color3.fromRGB(16,16,16),Card=Color3.fromRGB(26,26,26),CardHov=Color3.fromRGB(34,34,34),Accent=Color3.fromRGB(255,255,255),AccentDim=Color3.fromRGB(180,180,180),AccentFaint=Color3.fromRGB(48,48,48),TitleBar=Color3.fromRGB(10,10,10),Text=Color3.fromRGB(235,235,235),TextDim=Color3.fromRGB(130,130,130),TextFaint=Color3.fromRGB(55,55,55),OffBG=Color3.fromRGB(40,40,40),OnBG=Color3.fromRGB(210,210,210),Border=Color3.fromRGB(32,32,32),BorderLight=Color3.fromRGB(50,50,50),CloseRed=Color3.fromRGB(185,45,45),MinBtn=Color3.fromRGB(42,42,42),ActiveSide=Color3.fromRGB(245,245,245),InactiveSide=Color3.fromRGB(26,26,26),KeyGreen=Color3.fromRGB(30,180,80),KeyRed=Color3.fromRGB(200,50,50),KeyGold=Color3.fromRGB(220,180,50)}
...
local function makeScroll(parent) local sc=Instance.new("ScrollingFrame",parent);sc.Size=UDim2.new(1,0,1,0);sc.BackgroundTransparency=1;sc.ScrollBarThickness=3;sc.ScrollBarImageColor3=Tc.BorderLight;sc.CanvasSize=UDim2.new(0,0,0,0);sc.AutomaticCanvasSize=Enum.AutomaticSize.Y;sc.BorderSizePixel=0;return sc end
...
local function buildKeyMenu(onSuccess)
    ...
    local card=Instance.new("Frame",keyMenuGui);card.Size=UDim2.new(0,460,0,520);card.Position=UDim2.new(0.5,-230,0.5,-260);card.BackgroundColor3=Tc.BG;card.BorderSizePixel=0;corner(12,card)
    ...
    Instance.new("Frame",topBar).Size=UDim2.new(1,0,0.5,0)
    ...
    local sL=Instance.new("TextLabel",topBar);sL.Size=UDim2.new(1,0,0.4,0);sL.Position=UDim2.new(0,0,0.6,0);sL.BackgroundTransparency=1;sL.Text="v1.0  —  "..T("key_title");sL.TextColor3=Tc.TextFaint;sL.Font=Enum.Font.GothamMedium;sL.TextSize=11
    local profBg=Instance.new("Frame",card);profBg.Size=UDim2.new(1,-32,0,70);profBg.Position=UDim2.new(0,16,0,60);profBg.BackgroundColor3=Tc.Card;corner(10,profBg)
    local avF=Instance.new("Frame",profBg);avF.Size=UDim2.new(0,48,0,48);avF.Position=UDim2.new(0,10,0.5,-24);avF.BackgroundColor3=Tc.AccentFaint;corner(24,avF)
    ...
    iL(8,"@"..USERNAME,Tc.Text,15);iL(28,"HWID: "..HWID:sub(1,20).."…",Tc.TextFaint,11);iL(44,"UID: "..USER_ID,Tc.TextFaint,10)
    ...
    for _,bd in ipairs({{l=T("type_daily"),c=Tc.TextDim},{l=T("type_weekly"),c=Color3.fromRGB(80,180,255)},{l=T("type_monthly"),c=Color3.fromRGB(180,120,255)},{l=T("type_lifetime"),c=Tc.KeyGold}}) do
        local b=Instance.new("Frame",badgeRow);b.Size=UDim2.new(0,82,1,0);b.BackgroundColor3=Tc.Card;corner(5,b)
    ...
    local inLbl=Instance.new("TextLabel",card);inLbl.Size=UDim2.new(1,-32,0,18);inLbl.Position=UDim2.new(0,16,0,180);inLbl.BackgroundTransparency=1;inLbl.Text=T("key_enter");inLbl.TextColor3=Tc.TextFaint;inLbl.Font=Enum.Font.GothamBold;inLbl.TextSize=10;inLbl.TextXAlignment=Enum.TextXAlignment.Left
    local inputBox=Instance.new("TextBox",card);inputBox.Size=UDim2.new(1,-32,0,46);inputBox.Position=UDim2.new(0,16,0,200);inputBox.BackgroundColor3=Tc.Card;inputBox.TextColor3=Tc.Text;inputBox.Font=Enum.Font.GothamMedium;inputBox.TextSize=15;inputBox.PlaceholderText=T("key_placeholder");inputBox.PlaceholderColor3=Tc.TextFaint;inputBox.Text="";inputBox.ClearTextOnFocus=false;inputBox.BorderSizePixel=0;corner(8,inputBox);pad(inputBox,14,0)
    ...
    local keyInfoCard=Instance.new("Frame",card);keyInfoCard.Size=UDim2.new(1,-32,0,36);keyInfoCard.Position=UDim2.new(0,16,0,278);keyInfoCard.BackgroundColor3=Tc.Card;keyInfoCard.Visible=false;corner(8,keyInfoCard)
    ...
    local remLbl=Instance.new("TextLabel",remRow);remLbl.Size=UDim2.new(0.78,0,1,0);remLbl.BackgroundTransparency=1;remLbl.Text=T("key_remember");remLbl.TextColor3=Tc.TextDim;remLbl.Font=Enum.Font.GothamMedium;remLbl.TextSize=13;remLbl.TextXAlignment=Enum.TextXAlignment.Left
    local remOn=true
    local remPill=Instance.new("Frame",remRow);remPill.Size=UDim2.new(0,44,0,22);remPill.Position=UDim2.new(1,-44,0.5,-11);remPill.BackgroundColor3=Tc.OnBG;corner(22,remPill)
    ...
    remBtn.MouseButton1Click:Connect(function() remOn=not remOn;tw(remPill,0.18,{BackgroundColor3=remOn and Tc.OnBG or Tc.OffBG});tw(remKnob,0.18,{Position=UDim2.new(remOn and 1 or 0,remOn and -19 or 3,0.5,-8),BackgroundColor3=remOn and Tc.TitleBar or Tc.AccentDim}) end)
    local activateBtn=Instance.new("TextButton",card);activateBtn.Size=UDim2.new(1,-32,0,46);activateBtn.Position=UDim2.new(0,16,0,358);activateBtn.BackgroundColor3=Tc.Accent;activateBtn.TextColor3=Tc.BG;activateBtn.Font=Enum.Font.GothamBold;activateBtn.TextSize=16;activateBtn.Text=T("key_btn");corner(8,activateBtn)
    ...
    local footLbl=Instance.new("TextLabel",card);footLbl.Size=UDim2.new(1,-32,0,20);footLbl.Position=UDim2.new(0,16,0,412);footLbl.BackgroundTransparency=1;footLbl.Text=T("key_footer");footLbl.TextColor3=Tc.TextFaint;footLbl.Font=Enum.Font.GothamMedium;footLbl.TextSize=11
    ...
    local function tryActivate()
        ...
        busy=true;statusLbl.Text="Doğrulanıyor…";statusLbl.TextColor3=Tc.TextDim;activateBtn.Text=T("key_checking");activateBtn.BackgroundColor3=Tc.AccentFaint
        validateKey(key,function(ok,result,expires)
            ...
            if ok then
                ...
                local tn={daily=T("type_daily"),weekly=T("type_weekly"),monthly=T("type_monthly"),lifetime=T("type_lifetime")}
                local tc={daily=Tc.TextDim,weekly=Color3.fromRGB(80,180,255),monthly=Color3.fromRGB(180,120,255),lifetime=Tc.KeyGold}
                keyTypeLbl.Text=tn[result] or result:upper();keyTypeLbl.TextColor3=tc[result] or Tc.Text
                keyTimeLbl.Text=formatTimeLeft(expires);keyTimeLbl.TextColor3=expires==0 and Tc.KeyGold or Tc.KeyGreen
                ...
                tw(ibStroke,0.1,{Color=Tc.KeyRed});tw(inputBox,0.08,{BackgroundColor3=Color3.fromRGB(55,18,18)})
                task.wait(0.25);tw(inputBox,0.2,{BackgroundColor3=Tc.Card});tw(ibStroke,0.3,{Color=Tc.BorderLight})
...
-- Duvar kontrolü (Chams) - raycast ile görünürlük
local function isVisible(player)
    ...
    return result==nil -- nil ise engel yok, görünür
end
...
applyNameSpoof=function()
    ...
    local function spoofChar(char)
        ...
        -- Orijinal name tag'leri gizle
        for _,gui in ipairs(head:GetChildren()) do
            if gui:IsA("BillboardGui") and gui.Name~="SusanoSpoofTag" then
                gui.Enabled=not _G.NameSpoof
            end
        end
        -- Overhead name gizle
        pcall(function()
            local overhead=char:FindFirstChild("OverheadUI") or char:FindFirstChild("NameTag")
            if overhead then overhead.Enabled=not _G.NameSpoof end
        end)
        local existing=head:FindFirstChild("SusanoSpoofTag")
        if _G.NameSpoof then
            if not existing then
                local bb=Instance.new("BillboardGui",head);bb.Name="SusanoSpoofTag"
                bb.AlwaysOnTop=false;bb.Size=UDim2.new(0,250,0,36);bb.StudsOffset=Vector3.new(0,2.2,0)
            ...
            -- LocalPlayer'ın display name'ini de değiştir (client taraflı)
    ...
    if _G.NameSpoof then
        nameSpoofConn=LocalPlayer.CharacterAdded:Connect(function(char) task.wait(0.5);spoofChar(char) end)
    end
end
...
-- ESP - tam temizleme sistemi
local espCache,esp2D,espTracers={},{},{}

local function clearESPDrawings(p)
    -- 2D çizimleri temizle
    if esp2D[p] then
        for _,v in pairs(esp2D[p]) do
            pcall(function()
                v.Visible=false
                v:Remove()
            end)
...
local function clearAllESP()
    ...
    -- Kalan tüm çizimleri de temizle
    for p in pairs(esp2D) do clearESPDrawings(p) end
    for p in pairs(espTracers) do
        pcall(function() espTracers[p].Visible=false;espTracers[p]:Remove() end)
        espTracers[p]=nil
    end
end
...
local function buildESP(player)
    ...
    if espCache[player] then return end -- zaten var
...
local function updateESP()
    ...
    -- Mevcut oyuncuları kontrol et, olmayanları temizle
    local activePlayers={}
    for _,p in ipairs(Players:GetPlayers()) do activePlayers[p]=true end
    for p in pairs(espCache) do
        if not activePlayers[p] then clearESPPlayer(p) end
    end
    ...
    for player,cache in pairs(espCache) do
        ...
        -- Chams: duvar arkasıysa kırmızı, görünürse yeşil
        local vis=false
        if _G.WallCheck and show and not friendly then
            vis=isVisible(player)
        end
        local col
        if friendly then col=cFriend
        elseif _G.WallCheck then col=vis and cVis or cEnemy
        else col=cEnemy end

        -- 3D Highlight
        if cache.hl then
            cache.hl.Enabled=_G.ESPBox3D and show
            if cache.hl.Enabled then
                cache.hl.FillColor=col
                cache.hl.OutlineColor=col
                -- Duvar arkasındaysa AlwaysOnTop, görünürse normal
                if _G.WallCheck then
                    cache.hl.DepthMode=vis and Enum.HighlightDepthMode.Occluded or Enum.HighlightDepthMode.AlwaysOnTop
                else
                    cache.hl.DepthMode=Enum.HighlightDepthMode.AlwaysOnTop
                end
            end
        end

        -- Billboard (isim, mesafe, id)
        if cache.bb then
            cache.bb.Enabled=show
            if show then
                cache.idLbl.Visible=_G.ShowID;cache.idLbl.Text="ID: "..player.UserId
                cache.nameLbl.Visible=_G.ShowNames;cache.nameLbl.Text=player.Name
                cache.dstLbl.Visible=_G.ShowDistance;cache.dstLbl.Text=math.floor(dist).."m"
                cache.nameLbl.TextColor3=col
            end
        end

        -- Health bar
        if cache.hbBB then
            cache.hbBB.Enabled=_G.ShowHealthBar and show
            if cache.hbBB.Enabled and hum and hum.Health>0 then
                local pct=hum.Health/hum.MaxHealth
                cache.hbFill.Size=UDim2.new(1,0,pct,0);cache.hbFill.Position=UDim2.new(0,0,1-pct,0)
                cache.hbFill.BackgroundColor3=pct>0.6 and Color3.fromRGB(80,255,120) or(pct>0.3 and Color3.fromRGB(255,220,80) or Color3.fromRGB(255,80,80))
            end
        end
            ...
            if _G.ESPBox2D and show then
                ...
                if onSc then
                    ...
                    if head then
                        ...
                        local h=math.abs(sh.Y-sp.Y)*2.3;local w=h*0.55
                        local tl=Vector2.new(sp.X-w/2,sh.Y-h/2)
                        ...
                        e.box.Visible=false;e.name.Visible=false;e.dist.Visible=false;e.id.Visible=false;e.hbg.Visible=false;e.hfill.Visible=false
                    end
                else
                    e.box.Visible=false;e.name.Visible=false;e.dist.Visible=false;e.id.Visible=false;e.hbg.Visible=false;e.hfill.Visible=false
                end
        ...
        if tr then
            ...
            if _G.ShowTracer and show then
                local sp,onSc=Camera:WorldToViewportPoint(hrp.Position)
                if onSc then
                    tr.Visible=true;tr.From=Vector2.new(Camera.ViewportSize.X/2,Camera.ViewportSize.Y);tr.To=Vector2.new(sp.X,sp.Y);tr.Color=col
...
local function onChar(p)
    if _G.ESP then task.wait(1);buildESP(p) end
end

Players.PlayerAdded:Connect(function(p)
    p.CharacterAdded:Connect(function() onChar(p) end)
    if p.Character then onChar(p) end
    p.CharacterRemoving:Connect(function() clearESPPlayer(p) end)
    p.AncestryChanged:Connect(function() clearESPPlayer(p) end)
end)
...
local function buildToggle(parent,label,setting,yPos,onToggle)
    ...
    row.MouseEnter:Connect(function() tw(row,0.1,{BackgroundColor3=Tc.CardHov}) end);row.MouseLeave:Connect(function() tw(row,0.1,{BackgroundColor3=Tc.Card}) end)
    ...
    local pH,pW=24,50;local pill=Instance.new("Frame",row);pill.Size=UDim2.new(0,pW,0,pH);pill.Position=UDim2.new(1,-pW-12,0.5,-pH/2);pill.BackgroundColor3=_G[setting] and Tc.OnBG or Tc.OffBG;corner(pH,pill)
    ...
    hit.MouseButton1Click:Connect(function() _G[setting]=not _G[setting];tw(pill,0.18,{BackgroundColor3=_G[setting] and Tc.OnBG or Tc.OffBG});tw(knob,0.18,{Position=UDim2.new(_G[setting] and 1 or 0,_G[setting] and -(pH-3) or 3,0.5,-(pH-6)/2),BackgroundColor3=_G[setting] and Tc.TitleBar or Tc.AccentDim});if onToggle then onToggle(_G[setting]) end end)
    return yPos+52
end
...
local function buildSection(parent,txt,yPos)
    ...
    local line=Instance.new("Frame",parent);line.Size=UDim2.new(1,-28,0,1);line.Position=UDim2.new(0,14,0,yPos+20);line.BackgroundColor3=Tc.Border;line.BorderSizePixel=0;return yPos+30
end
...
local function buildColorPreview(parent,sR,sG,sB,yPos)
    ...
    local lbl=Instance.new("TextLabel",row);lbl.Size=UDim2.new(0.5,0,1,0);lbl.Position=UDim2.new(0,12,0,0);lbl.BackgroundTransparency=1;lbl.Text=T("vis_preview");lbl.TextColor3=Tc.TextDim;lbl.Font=Enum.Font.GothamMedium;lbl.TextSize=13;lbl.TextXAlignment=Enum.TextXAlignment.Left
...
tabBuilders["ESP"]=function(p)
    ...
    y=buildSection(sc,T("sec_visibility"),y);y=buildToggle(sc,T("esp_active"),"ESP",y,function(v) if not v then clearAllESP() end end);y=buildToggle(sc,T("esp_3d"),"ESPBox3D",y);y=buildToggle(sc,T("esp_2d"),"ESPBox2D",y);y=buildToggle(sc,T("esp_skel"),"SkeletonESP",y)
    y=buildSection(sc,T("sec_labels"),y+4);y=buildToggle(sc,T("esp_names"),"ShowNames",y);y=buildToggle(sc,T("esp_dist"),"ShowDistance",y);y=buildToggle(sc,T("esp_health"),"ShowHealthBar",y);y=buildToggle(sc,T("esp_id"),"ShowID",y);y=buildToggle(sc,T("esp_tracer"),"ShowTracer",y);y=buildSlider(sc,T("esp_tracer_thick"),"TracerThick",y,0.5,6,"%.1f")
    y=buildSection(sc,T("sec_filters"),y+4);y=buildToggle(sc,T("esp_team_check"),"TeamCheck",y);y=buildToggle(sc,T("esp_friendly"),"ShowFriendly",y);y=buildToggle(sc,T("esp_wall"),"WallCheck",y)
    y=buildSection(sc,T("esp_enemy_col"),y+4);y=buildColorPreview(sc,"ESPEnemyR","ESPEnemyG","ESPEnemyB",y);y=buildSlider(sc,T("vis_red"),"ESPEnemyR",y,0,255,nil);y=buildSlider(sc,T("vis_green"),"ESPEnemyG",y,0,255,nil);y=buildSlider(sc,T("vis_blue"),"ESPEnemyB",y,0,255,nil)
    y=buildSection(sc,T("esp_friend_col"),y+4);y=buildColorPreview(sc,"ESPFriendR","ESPFriendG","ESPFriendB",y);y=buildSlider(sc,T("vis_red"),"ESPFriendR",y,0,255,nil);y=buildSlider(sc,T("vis_green"),"ESPFriendG",y,0,255,nil);y=buildSlider(sc,T("vis_blue"),"ESPFriendB",y,0,255,nil)
    y=buildSection(sc,T("esp_visible_col"),y+4);y=buildColorPreview(sc,"ESPVisR","ESPVisG","ESPVisB",y);y=buildSlider(sc,T("vis_red"),"ESPVisR",y,0,255,nil);y=buildSlider(sc,T("vis_green"),"ESPVisG",y,0,255,nil);y=buildSlider(sc,T("vis_blue"),"ESPVisB",y,0,255,nil)
    y=buildSection(sc,T("esp_crosshair"),y+4);y=buildToggle(sc,T("esp_crosshair"),"Crosshair",y,function() buildCrosshair() end)
    y=buildDropdown(sc,T("esp_style"),CH_STYLES,function() return _G.CrosshairStyle end,function(v) _G.CrosshairStyle=v;buildCrosshair() end,y)
    y=buildSlider(sc,T("esp_size"),"CrosshairSize",y,4,50,nil,function() buildCrosshair() end);y=buildSlider(sc,T("esp_thick"),"CrosshairThick",y,1,8,nil,function() buildCrosshair() end);y=buildSlider(sc,T("esp_gap"),"CrosshairGap",y,0,24,nil,function() buildCrosshair() end);y=buildSlider(sc,T("esp_opacity"),"CrosshairAlpha",y,0.1,1.0,"%.1f",function() buildCrosshair() end)
    y=buildToggle(sc,T("esp_dot"),"CrosshairDot",y,function() buildCrosshair() end);y=buildToggle(sc,T("esp_outline"),"CrosshairOutline",y,function() buildCrosshair() end)
    y=buildSection(sc,T("esp_ch_col"),y+4);y=buildColorPreview(sc,"CrosshairR","CrosshairG","CrosshairB",y);y=buildSlider(sc,T("vis_red"),"CrosshairR",y,0,255,nil,function() buildCrosshair() end);y=buildSlider(sc,T("vis_green"),"CrosshairG",y,0,255,nil,function() buildCrosshair() end);y=buildSlider(sc,T("vis_blue"),"CrosshairB",y,0,255,nil,function() buildCrosshair() end)
end
tabBuilders["AIMBOT"]=function(p)
    local sc=makeScroll(p);local y=10
    y=buildSection(sc,T("sec_aimbot"),y);y=buildToggle(sc,T("aim_aimbot"),"Aimbot",y);y=buildToggle(sc,T("aim_rage"),"RageAimbot",y,function(v) if v then enableRageAimbot() else disableRageAimbot() end end)
    y=buildSection(sc,T("sec_silent"),y+4);y=buildToggle(sc,T("aim_silent"),"SilentAim",y,function(v) if v then enableSilentAim() else disableSilentAim() end end)
    y=buildSection(sc,T("sec_fov"),y+4);y=buildToggle(sc,T("aim_fov_filter"),"UseFOV",y);y=buildToggle(sc,T("aim_fov_circle"),"FOVVisible",y,function(v) if FOVCircle then FOVCircle.Visible=v end end);y=buildSlider(sc,T("aim_fov_size"),"FOVSize",y,20,400,nil)
    y=buildSection(sc,T("sec_smooth"),y+4);y=buildSlider(sc,T("aim_smooth"),"AimbotSmoothness",y,0.02,1.0,"%.2f")
    y=buildSection(sc,T("sec_target"),y+4);y=buildToggle(sc,T("aim_head"),"AimbotPartHead",y);y=buildToggle(sc,T("aim_chest"),"AimbotPartChest",y);y=buildToggle(sc,T("aim_stomach"),"AimbotPartStomach",y)
end
tabBuilders["OTHER"]=function(p)
    local sc=makeScroll(p);local y=10
    y=buildSection(sc,T("sec_fly"),y);y=buildToggle(sc,T("move_fly"),"FlyEnabled",y,function(v) if v then enableFly() else disableFly() end end);y=buildSlider(sc,T("move_fly_speed"),"FlySpeed",y,10,300,nil)
    y=buildSection(sc,T("sec_move"),y+4);y=buildToggle(sc,T("move_noclip"),"NoClipEnabled",y,function(v) if v then enableNoclip() else disableNoclip() end end);y=buildToggle(sc,T("move_inf_jump"),"InfiniteJump",y,function(v) if v then enableInfiniteJump() else disableInfiniteJump() end end);y=buildToggle(sc,T("move_long_jump"),"LongJump",y,function(v) if v then enableLongJump() else disableLongJump() end end);y=buildSlider(sc,T("move_jump_power"),"LongJumpPower",y,20,200,nil);y=buildToggle(sc,T("move_swim"),"SwimHack",y)
    y=buildSection(sc,T("sec_bhop"),y+4);y=buildToggle(sc,T("move_bhop"),"BunnyHop",y,function(v) if v then enableBhop() else disableBhop() end end);y=buildSlider(sc,T("move_bhop_speed"),"BunnyHopSpeed",y,1.0,3.0,"%.1f")
    y=buildSection(sc,T("sec_speed"),y+4);y=buildToggle(sc,T("move_speed"),"SpeedHack",y,function(v) if v then enableSpeed() else disableSpeed() end end);y=buildSlider(sc,T("move_speed_mult"),"SpeedMultiplier",y,1.0,10.0,"%.1f")
    y=buildSection(sc,T("sec_other"),y+4);y=buildToggle(sc,T("move_stream"),"StreamProof",y,function(v) if MainGui then MainGui.DisplayOrder=v and 200 or 10 end end)
end
tabBuilders["PLAYERS"]=function(p)
    local sc=makeScroll(p);local y=10
    y=buildSection(sc,T("sec_combat"),y);y=buildToggle(sc,T("play_kill_aura"),"KillAura",y,function(v) if v then enableKillAura() else disableKillAura() end end);y=buildSlider(sc,T("play_range"),"KillAuraRange",y,5,50,nil)
    y=buildSection(sc,T("sec_helper"),y+4);y=buildToggle(sc,T("play_anti_afk"),"AntiAFK",y,function(v) if v then enableAntiAFK() else disableAntiAFK() end end)
    y=buildSection(sc,T("sec_spoof"),y+4);y=buildToggle(sc,T("play_name_spoof"),"NameSpoof",y,function() applyNameSpoof() end)
    local nameBox;nameBox,y=buildInput(sc,T("play_fake_name"),"İsim gir","",y);local applyBtn;applyBtn,y=buildButton(sc,T("play_apply"),y);applyBtn.MouseButton1Click:Connect(function() _G.SpoofedName=nameBox.Text;applyNameSpoof() end)
    y=buildSection(sc,T("play_list"),y+4);local stopBtn,_=buildButton(sc,T("play_stop_spec"),y,Tc.AccentFaint,Tc.Text);y=y+46;stopBtn.MouseButton1Click:Connect(stopSpectating)
    local plist=Instance.new("ScrollingFrame",sc);plist.Size=UDim2.new(1,-28,0,260);plist.Position=UDim2.new(0,14,0,y);plist.BackgroundColor3=Tc.Card;corner(8,plist);plist.ScrollBarThickness=3;plist.ScrollBarImageColor3=Tc.BorderLight;plist.CanvasSize=UDim2.new(0,0,0,0);plist.AutomaticCanvasSize=Enum.AutomaticSize.Y;plist.BorderSizePixel=0
...
tabBuilders["ITEM"]=function(p)
    local sc=makeScroll(p);local y=10;y=buildSection(sc,"Eşya Ver",y);local pBox;pBox,y=buildInput(sc,"Kullanıcı","İsim","",y);local tBox;tBox,y=buildInput(sc,"Eşya","Sword","",y);local cBox;cBox,y=buildInput(sc,"Adet","1","1",y);local gBtn;gBtn,y=buildButton(sc,"Ver",y);local sBtn;sBtn,y=buildButton(sc,"Ara",y,Tc.AccentFaint,Tc.Text)
    ...
    local toolsF=Instance.new("Frame",sc);toolsF.Size=UDim2.new(1,-28,0,180);toolsF.Position=UDim2.new(0,14,0,y);toolsF.BackgroundColor3=Tc.Card;corner(8,toolsF);local tlbl=Instance.new("TextLabel",toolsF);tlbl.Size=UDim2.new(1,0,0,26);tlbl.BackgroundTransparency=1;tlbl.Text="Eşya Listesi";tlbl.TextColor3=Tc.TextDim;tlbl.Font=Enum.Font.GothamBold;tlbl.TextSize=11;local tsc=Instance.new("ScrollingFrame",toolsF);tsc.Size=UDim2.new(1,-8,1,-30);tsc.Position=UDim2.new(0,4,0,28);tsc.BackgroundTransparency=1;tsc.ScrollBarThickness=3;tsc.CanvasSize=UDim2.new(0,0,0,0);tsc.AutomaticCanvasSize=Enum.AutomaticSize.Y;tsc.BorderSizePixel=0;Instance.new("UIListLayout",tsc).Padding=UDim.new(0,3)
    local function rfr() for _,c in ipairs(tsc:GetChildren()) do if c:IsA("TextButton") then c:Destroy() end end;task.spawn(function() local found={};for _,loc in ipairs({ServerStorage,ReplicatedStorage,Workspace}) do for _,item in ipairs(loc:GetDescendants()) do if item:IsA("Tool") then found[item.Name]=true end end end;local cnt=0;for name in pairs(found) do local btn=Instance.new("TextButton",tsc);btn.Size=UDim2.new(1,0,0,26);btn.Text=name;btn.TextColor3=Tc.Text;btn.Font=Enum.Font.Gotham;btn.TextSize=13;btn.BackgroundColor3=Tc.CardHov;corner(5,btn);btn.MouseButton1Click:Connect(function() tBox.Text=name end);cnt=cnt+1 end;res.Text=cnt>0 and(cnt.." bulundu") or "Bulunamadı";res.TextColor3=cnt>0 and Tc.KeyGreen or Tc.KeyRed end) end
    gBtn.MouseButton1Click:Connect(function() local ok,msg=giveItem(pBox.Text,tBox.Text,math.clamp(tonumber(cBox.Text) or 1,1,20));res.Text=msg;res.TextColor3=ok and Tc.KeyGreen or Tc.KeyRed end);sBtn.MouseButton1Click:Connect(rfr);rfr()
end
tabBuilders["TEAM CHANGE"]=function(p)
    ...
    cBtn.MouseButton1Click:Connect(function() if uBox.Text=="" or tBox.Text=="" then res.Text="Doldur!";res.TextColor3=Tc.KeyRed;return end;local ok,msg=changeTeam(uBox.Text,tBox.Text);res.Text=msg;res.TextColor3=ok and Tc.KeyGreen or Tc.KeyRed;_G.TeamChangePlayerName=uBox.Text;_G.TeamChangeTeamName=tBox.Text end)
end
tabBuilders["VISUAL"]=function(p)
    local sc=makeScroll(p);local y=10
    y=buildSection(sc,T("sec_lighting"),y);y=buildToggle(sc,T("vis_fullbright"),"FullBright",y,function(v) applyFullBright(v) end);y=buildToggle(sc,T("vis_nofog"),"NoFog",y,function(v) applyNoFog(v) end)
    y=buildSection(sc,T("sec_camera"),y+4);y=buildToggle(sc,T("vis_fov"),"FOVChanger",y,function(v) if not v then Camera.FieldOfView=origCamFOV end end);y=buildSlider(sc,T("vis_fov_val"),"FOVChangerVal",y,50,200,nil,function(v) if _G.FOVChanger then Camera.FieldOfView=v end end)
    y=buildToggle(sc,T("vis_3rdperson"),"ThirdPerson",y,function(v) if v then enableThirdPerson() else disableThirdPerson() end end);y=buildSlider(sc,T("vis_dist"),"ThirdPersonDist",y,4,30,nil)
    y=buildSection(sc,T("sec_world"),y+4);y=buildToggle(sc,T("vis_time"),"TimeChanger",y,function(v) applyTime(v) end);y=buildSlider(sc,T("vis_time_val"),"TimeOfDay",y,0,23,nil,function(v) if _G.TimeChanger then applyTime(true) end end)
    y=buildSection(sc,T("sec_world_col"),y+4);y=buildToggle(sc,T("vis_world_col"),"WorldColor",y,function(v) applyWorldColor(v) end);y=buildColorPreview(sc,"WorldR","WorldG","WorldB",y);y=buildSlider(sc,T("vis_red"),"WorldR",y,0,255,nil,function() if _G.WorldColor then applyWorldColor(true) end end);y=buildSlider(sc,T("vis_green"),"WorldG",y,0,255,nil,function() if _G.WorldColor then applyWorldColor(true) end end);y=buildSlider(sc,T("vis_blue"),"WorldB",y,0,255,nil,function() if _G.WorldColor then applyWorldColor(true) end end)
end
tabBuilders["CONFIG"]=function(p)
    local sc=makeScroll(p);local y=10
    local ic=Instance.new("Frame",sc);ic.Size=UDim2.new(1,-28,0,40);ic.Position=UDim2.new(0,14,0,y);ic.BackgroundColor3=Tc.AccentFaint;corner(8,ic);local il=Instance.new("TextLabel",ic);il.Size=UDim2.new(1,-16,1,0);il.Position=UDim2.new(0,8,0,0);il.BackgroundTransparency=1;il.Text=T("cfg_info");il.TextColor3=Tc.TextDim;il.Font=Enum.Font.Gotham;il.TextSize=12;il.TextWrapped=true;il.TextXAlignment=Enum.TextXAlignment.Left;y=y+48
    y=buildSection(sc,T("cfg_save"),y);local nameBox;nameBox,y=buildInput(sc,T("cfg_name"),"benim-config","",y);local saveBtn;saveBtn,y=buildButton(sc,T("cfg_save_btn"),y,Tc.KeyGreen,Color3.new(1,1,1))
    ...
    saveBtn.MouseButton1Click:Connect(function()
        local n=nameBox.Text:gsub("[^%w%-_]",""):lower();if n=="" then res.Text="Ad gir!";res.TextColor3=Tc.KeyRed;return end
        saveBtn.Text=T("cfg_saving");res.Text="Yükleniyor…";res.TextColor3=Tc.TextDim
        local ok2,json=pcall(function() return HttpService:JSONEncode(buildConfigData()) end)
        if not ok2 then res.Text="JSON hatası";res.TextColor3=Tc.KeyRed;saveBtn.Text=T("cfg_save_btn");return end
        local ok,gistId=gistCreate(n,json);saveBtn.Text=T("cfg_save_btn")
        if ok then local gmap=loadGistMap();gmap[n]=gistId;saveGistMap(gmap);res.Text=T("cfg_saved_ok")..gistId;res.TextColor3=Tc.KeyGreen
        else res.Text=T("cfg_fail");res.TextColor3=Tc.KeyRed end
    end)
    y=buildSection(sc,T("cfg_load"),y+4);local codeBox;codeBox,y=buildInput(sc,T("cfg_gist_id"),"abc123...","",y);local loadBtn;loadBtn,y=buildButton(sc,T("cfg_load_btn"),y,Color3.fromRGB(40,100,200),Color3.new(1,1,1))
    ...
    loadBtn.MouseButton1Click:Connect(function()
        local gistId=codeBox.Text:gsub("%s+","");if gistId=="" then loadRes.Text="ID gir!";loadRes.TextColor3=Tc.KeyRed;return end
        loadBtn.Text="Yükleniyor...";loadRes.Text="Çekiliyor…";loadRes.TextColor3=Tc.TextDim
        local ok,data=gistRead(gistId);loadBtn.Text=T("cfg_load_btn")
        if ok and data then applyConfigData(data);buildCrosshair();loadRes.Text=T("cfg_load_ok")..(data.savedBy and(" ("..data.savedBy..")") or "");loadRes.TextColor3=Tc.KeyGreen
        else loadRes.Text=T("cfg_fail");loadRes.TextColor3=Tc.KeyRed end
    end)
    y=buildSection(sc,T("cfg_saved"),y+4);local gmap=loadGistMap();local has=false
    for cfgName,gistId in pairs(gmap) do
        has=true;local row=Instance.new("Frame",sc);row.Size=UDim2.new(1,-28,0,48);row.Position=UDim2.new(0,14,0,y);row.BackgroundColor3=Tc.Card;corner(8,row)
        local nl=Instance.new("TextLabel",row);nl.Size=UDim2.new(1,-200,1,0);nl.Position=UDim2.new(0,12,0,0);nl.BackgroundTransparency=1;nl.Text=cfgName;nl.TextColor3=Tc.Text;nl.Font=Enum.Font.GothamSemibold;nl.TextSize=13;nl.TextXAlignment=Enum.TextXAlignment.Left
        ...
        local lb=mkB(T("cfg_load_btn"),Tc.KeyGreen,-176);local cb=mkB("Kod",Tc.AccentFaint,-114);local db=mkB("Sil",Tc.KeyRed,-52)
        lb.MouseButton1Click:Connect(function() lb.Text="…";local ok,data=gistRead(gistId);lb.Text=T("cfg_load_btn");if ok and data then applyConfigData(data);buildCrosshair();res.Text=T("cfg_load_ok");res.TextColor3=Tc.KeyGreen else res.Text=T("cfg_fail");res.TextColor3=Tc.KeyRed end end)
        cb.MouseButton1Click:Connect(function() res.Text="ID: "..gistId;res.TextColor3=Tc.TextDim end)
    ...
    if not has then local el=Instance.new("TextLabel",sc);el.Size=UDim2.new(1,-28,0,28);el.Position=UDim2.new(0,14,0,y);el.BackgroundTransparency=1;el.Text=T("cfg_no_config");el.TextColor3=Tc.TextFaint;el.Font=Enum.Font.GothamMedium;el.TextSize=13;el.TextXAlignment=Enum.TextXAlignment.Left end
end
tabBuilders["ABOUT"]=function(p)
    local sc=makeScroll(p);local lF=Instance.new("Frame",sc);lF.Size=UDim2.new(1,-28,0,80);lF.Position=UDim2.new(0,14,0,10);lF.BackgroundColor3=Tc.Card;corner(10,lF)
    local ll=Instance.new("TextLabel",lF);ll.Size=UDim2.new(1,0,0.55,0);ll.BackgroundTransparency=1;ll.Text="SUSANO";ll.TextColor3=Tc.Text;ll.Font=Enum.Font.GothamBlack;ll.TextSize=38
    local vl=Instance.new("TextLabel",lF);vl.Size=UDim2.new(1,0,0.25,0);vl.Position=UDim2.new(0,0,0.55,0);vl.BackgroundTransparency=1;vl.Text="v1.0  |  "..keyType:upper().."  |  "..USERNAME.."  |  "..formatTimeLeft(keyExpires);vl.TextColor3=Tc.TextDim;vl.Font=Enum.Font.GothamMedium;vl.TextSize=12
    local y=104
    for _,row in ipairs({
        {T("tab_esp").."/Chams", T("about_esp")},
        {"Kısayol", T("about_shortcut")},
        {"Key", T("about_key")},
        {"Config", T("about_config")},
        {"GUI", T("about_gui")},
    }) do
        local card=Instance.new("Frame",sc);card.Size=UDim2.new(1,-28,0,0);card.AutomaticSize=Enum.AutomaticSize.Y;card.Position=UDim2.new(0,14,0,y);card.BackgroundColor3=Tc.Card;corner(8,card)
        local tl=Instance.new("TextLabel",card);tl.Size=UDim2.new(1,0,0,20);tl.Position=UDim2.new(0,12,0,8);tl.BackgroundTransparency=1;tl.Text=string.upper(row[1]);tl.TextColor3=Tc.TextFaint;tl.Font=Enum.Font.GothamBold;tl.TextSize=10;tl.TextXAlignment=Enum.TextXAlignment.Left
        local bl=Instance.new("TextLabel",card);bl.Size=UDim2.new(1,-24,0,0);bl.Position=UDim2.new(0,12,0,26);bl.AutomaticSize=Enum.AutomaticSize.Y;bl.BackgroundTransparency=1;bl.Text=row[2];bl.TextColor3=Tc.Text;bl.Font=Enum.Font.Gotham;bl.TextSize=13;bl.TextWrapped=true;bl.TextXAlignment=Enum.TextXAlignment.Left
...
local function getTabs()
    return {
        ...
        {id="OTHER",icon="[M]",label=T("tab_move")},
        {id="PLAYERS",icon="[P]",label=T("tab_players")},
        {id="ITEM",icon="[I]",label=T("tab_item")},
        {id="TEAM CHANGE",icon="[T]",label=T("tab_team")},
        {id="VISUAL",icon="[V]",label=T("tab_visual")},
        {id="CONFIG",icon="[C]",label=T("tab_config")},
        {id="ABOUT",icon="[?]",label=T("tab_about")},
    }
end
local sideButtons={}
...
switchTab=function(id)
    ...
    for _,btn in ipairs(sideButtons) do
        local active=btn:GetAttribute("tabId")==id;tw(btn,0.15,{BackgroundColor3=active and Tc.ActiveSide or Tc.InactiveSide})
        local il=btn:FindFirstChild("IconLbl");local nl=btn:FindFirstChild("NameLbl")
        if il then tw(il,0.15,{TextColor3=active and Tc.BG or Tc.TextFaint}) end;if nl then tw(nl,0.15,{TextColor3=active and Tc.BG or Tc.TextDim}) end
    end
...
local function createMenu()
    ...
    MainFrame=Instance.new("Frame",MainGui);MainFrame.Size=MENU_FULL;MainFrame.Position=UDim2.new(0.5,-435,0.5,-320);MainFrame.BackgroundColor3=Tc.BG;MainFrame.Active=true;MainFrame.ClipsDescendants=false;corner(10,MainFrame)
    ...
    Instance.new("UIStroke",MainFrame).Color=Tc.BorderLight
    ...
    local titleLine=Instance.new("Frame",tb);titleLine.Size=UDim2.new(1,0,0,1);titleLine.Position=UDim2.new(0,0,1,-1);titleLine.BackgroundColor3=Tc.BorderLight;titleLine.BorderSizePixel=0;titleLine.BackgroundTransparency=0.5
    local logoTxt=Instance.new("TextLabel",tb);logoTxt.Size=UDim2.new(0,100,1,0);logoTxt.Position=UDim2.new(0,16,0,0);logoTxt.BackgroundTransparency=1;logoTxt.Text="SUSANO";logoTxt.TextColor3=Tc.Accent;logoTxt.Font=Enum.Font.GothamBlack;logoTxt.TextSize=18;logoTxt.TextXAlignment=Enum.TextXAlignment.Left
    local verTxt=Instance.new("TextLabel",tb);verTxt.Size=UDim2.new(0,40,1,0);verTxt.Position=UDim2.new(0,105,0,0);verTxt.BackgroundTransparency=1;verTxt.Text="v1.0";verTxt.TextColor3=Tc.TextFaint;verTxt.Font=Enum.Font.GothamMedium;verTxt.TextSize=11;verTxt.TextXAlignment=Enum.TextXAlignment.Left
    local kBadge=Instance.new("Frame",tb);kBadge.Size=UDim2.new(0,76,0,22);kBadge.Position=UDim2.new(0,156,0.5,-11);kBadge.BackgroundColor3=keyType=="lifetime" and Tc.KeyGold or(keyType=="monthly" and Color3.fromRGB(180,120,255) or(keyType=="weekly" and Color3.fromRGB(80,180,255) or Tc.AccentFaint));corner(5,kBadge)
    ...
    local kn={daily=T("type_daily"),weekly=T("type_weekly"),monthly=T("type_monthly"),lifetime=T("type_lifetime")};kBL.Text=kn[keyType] or keyType:upper()
    local timeLbl=Instance.new("TextLabel",tb);timeLbl.Size=UDim2.new(0,110,1,0);timeLbl.Position=UDim2.new(0,240,0,0);timeLbl.BackgroundTransparency=1;timeLbl.TextColor3=Tc.TextFaint;timeLbl.Font=Enum.Font.GothamMedium;timeLbl.TextSize=10;timeLbl.TextXAlignment=Enum.TextXAlignment.Left;timeLbl.Text=formatTimeLeft(keyExpires)
    task.spawn(function() while MainGui and MainGui.Parent do timeLbl.Text=formatTimeLeft(keyExpires);task.wait(60) end end)
    local hotkeyTxt=Instance.new("TextLabel",tb);hotkeyTxt.Size=UDim2.new(0,80,1,0);hotkeyTxt.Position=UDim2.new(0.5,-40,0,0);hotkeyTxt.BackgroundTransparency=1;hotkeyTxt.Text="F5 aç/kapat";hotkeyTxt.TextColor3=Tc.TextFaint;hotkeyTxt.Font=Enum.Font.GothamMedium;hotkeyTxt.TextSize=11

    -- Dil butonu
    local langBtn=Instance.new("TextButton",tb);langBtn.Size=UDim2.new(0,46,0,28);langBtn.Position=UDim2.new(1,-118,0.5,-14);langBtn.BackgroundColor3=Tc.AccentFaint;langBtn.TextColor3=Tc.Text;langBtn.Font=Enum.Font.GothamBold;langBtn.TextSize=11;langBtn.Text=T("lang_btn");corner(6,langBtn)
    langBtn.MouseButton1Click:Connect(function()
        ...
        for i,btn in ipairs(sideButtons) do
            local nl=btn:FindFirstChild("NameLbl")
    ...
    local closeBtn=mkTBtn("x",Tc.CloseRed,-36);closeBtn.MouseEnter:Connect(function() tw(closeBtn,0.1,{BackgroundColor3=Color3.fromRGB(220,70,70)}) end);closeBtn.MouseLeave:Connect(function() tw(closeBtn,0.1,{BackgroundColor3=Tc.CloseRed}) end);closeBtn.MouseButton1Click:Connect(function() tw(MainFrame,0.18,{BackgroundTransparency=1});task.wait(0.2);MainGui.Enabled=false;MainFrame.BackgroundTransparency=0 end)
    local minBtn=mkTBtn("-",Tc.MinBtn,-70);minBtn.MouseButton1Click:Connect(function() minimized=not minimized;tw(MainFrame,0.2,{Size=minimized and MENU_MINI or MENU_FULL});task.wait(0.05);SideBar.Visible=not minimized;Content.Visible=not minimized end)

    SideBar=Instance.new("Frame",MainFrame);SideBar.Size=UDim2.new(0,170,1,-46);SideBar.Position=UDim2.new(0,0,0,46);SideBar.BackgroundColor3=Tc.Sidebar;SideBar.BorderSizePixel=0;corner(10,SideBar)
    local sbF=Instance.new("Frame",SideBar);sbF.Size=UDim2.new(1,0,0.5,0);sbF.BackgroundColor3=Tc.Sidebar;sbF.BorderSizePixel=0
    local sideDiv=Instance.new("Frame",MainFrame);sideDiv.Size=UDim2.new(0,1,1,-46);sideDiv.Position=UDim2.new(0,170,0,46);sideDiv.BackgroundColor3=Tc.BorderLight;sideDiv.BorderSizePixel=0;sideDiv.BackgroundTransparency=0.5

    sideButtons={}
    local TABS=getTabs()
    for i,tab in ipairs(TABS) do
        local btn=Instance.new("TextButton",SideBar);btn.Size=UDim2.new(1,-14,0,34);btn.Position=UDim2.new(0,7,0,5+(i-1)*37);btn.BackgroundColor3=tab.id==currentTab and Tc.ActiveSide or Tc.InactiveSide;btn.AutoButtonColor=false;btn.BorderSizePixel=0;btn.Text="";corner(7,btn);btn:SetAttribute("tabId",tab.id)
        local iL=Instance.new("TextLabel",btn);iL.Name="IconLbl";iL.Size=UDim2.new(0,30,1,0);iL.Position=UDim2.new(0,6,0,0);iL.BackgroundTransparency=1;iL.Text=tab.icon;iL.TextColor3=tab.id==currentTab and Tc.BG or Tc.TextFaint;iL.Font=Enum.Font.GothamBold;iL.TextSize=10
        local nL=Instance.new("TextLabel",btn);nL.Name="NameLbl";nL.Size=UDim2.new(1,-38,1,0);nL.Position=UDim2.new(0,34,0,0);nL.BackgroundTransparency=1;nL.Text=tab.label;nL.TextColor3=tab.id==currentTab and Tc.BG or Tc.TextDim;nL.Font=Enum.Font.GothamSemibold;nL.TextSize=13;nL.TextXAlignment=Enum.TextXAlignment.Left
        btn.MouseEnter:Connect(function() if btn:GetAttribute("tabId")~=currentTab then tw(btn,0.1,{BackgroundColor3=Tc.CardHov}) end end);btn.MouseLeave:Connect(function() if btn:GetAttribute("tabId")~=currentTab then tw(btn,0.1,{BackgroundColor3=Tc.InactiveSide}) end end);btn.MouseButton1Click:Connect(function() switchTab(tab.id) end);table.insert(sideButtons,btn)
    end
    ...
    local rH=Instance.new("Frame",MainFrame);rH.Size=UDim2.new(0,12,0,12);rH.Position=UDim2.new(1,-12,1,-12);rH.BackgroundTransparency=1;local rD=Instance.new("Frame",rH);rD.Size=UDim2.new(0,4,0,4);rD.Position=UDim2.new(1,-4,1,-4);rD.BackgroundColor3=Tc.BorderLight;rD.BackgroundTransparency=0.3;corner(2,rD)
