...
local DISCORD_LINK=".gg/tCufFEMdux"

-- JSON HASH TRACKING (keys.json değişince HWID sıfırla)
local KEYS_JSON_HASH=""
...
local function makeTc()
    ...
    local ac
    if th.rainbow and rainbowEnabled then 
        ac=hsvToRgb(rainbowHue,1,1) 
    else 
        ac=rgb(th.ac) 
    end
    local bgC=rgb(th.bg)
...
local LANGS={
    TR={
        ...
        sec_speed="Hiz",sec_tp="Teleport",sec_gravity="Yercekimi",sec_other="Diger",
        sec_combat="Savas",sec_helper="Yardimci",sec_spoof="Isim Degistir",sec_lighting="Aydinlatma",
        ...
        sec_hitbox="Hitbox",sec_fakelag="Fake Lag",sec_godmode="Godmode",
        sec_lang="Dil",sec_theme="Menu Rengi",sec_about="Hakkinda",
        lang_tr="Turkce",lang_en="Ingilizce",lang_es="Ispanyolca",
        cfg_name="Config Adi",cfg_save="Kaydet",cfg_load="Yukle",cfg_delete="Sil",
        cfg_no_configs="Kayitli config yok.",cfg_enter_name="Isim gir!",
        cfg_saved="Kaydedildi!",cfg_loaded="Yuklendi!",cfg_deleted="Silindi.",cfg_fail="Basarisiz.",
        esp_aktif="ESP Aktif",esp_3d="3D Highlight",esp_2d="2D Box",esp_skeleton="Skeleton ESP",
        show_names="Isim Goster",show_distance="Mesafe Goster",show_health="Can Cubugu Goster",
        show_id="ID Goster",show_tracer="Tracer Goster",
        enemy_color="Dusman Rengi",friend_color="Dost Rengi",visible_color="Gorunur Renk",
        aimbot_label="Aimbot",rage_aimbot="Rage Aimbot",silent_aim="Silent Aim",
        hitbox_expand="Hitbox Buyut",fake_lag="Fake Lag",
        fly="Ucus",noclip="Noclip",inf_jump="Sonsuz Ziplama",long_jump="Uzun Atlama",
        swim_hack="Yuzme Hack",bhop="Bunny Hop",speed_hack="Hiz Hack",
        gravity="Yercekimi Hack",cursor_tp="Cursor Teleport",
        kill_aura="Kill Aura",anti_afk="Anti AFK",name_spoof="Isim Spoof",
        full_bright="Full Bright",no_fog="Sis Kaldir",fov_changer="FOV Degistir",
        third_person="3. Sahis Kamera",time_changer="Saat Degistir",world_color="Dunya Rengi",
        auto_rejoin="Oto Giris",fps_boost="FPS Boost",chat_logger="Sohbet Kaydi",
        minimap="MiniMap / Radar",godmode="Olumsuzluk (Godmode)",
        crosshair="Nisangah",cross_style="Stil",cross_size="Boyut",cross_thick="Kalinlik",
        cross_gap="Bosluk",cross_alpha="Opaklik",cross_dot="Merkez Nokta",cross_outline="Dis Cizgi",
        tracer_thick="Tracer Kalinligi",hitbox_size="Hitbox Boyutu",
        lag_interval="Lag Araligi",fly_speed="Ucus Hizi",bhop_speed="Bunny Hizi",
        speed_mult="Hiz Carpani",jump_power="Ziplama Gucu",long_power="Atlama Gucu",
        gravity_val="Yercekimi Degeri",kill_range="Kill Menzili",
        fov_size="FOV Buyuklugu",smoothness="Yumusaklik",
        spoof_name="Sahte Isim",apply="Uygula",stop_spec="Izlemeyi Durdur",
        server_hop="Server Hop",player_list="Oyuncu Listesi",
        godmode_info="Godmode aktif - Karakteriniz olmeyecek",
        godmode_warn="NOT: Bazi oyunlarda ban riski olabilir!",
    },
    EN={
        tab_esp="ESP",tab_aimbot="Aimbot",tab_move="Movement",tab_players="Players",
        tab_visual="Visual",tab_misc="Misc",tab_config="Config",tab_settings="Settings",
        key_btn="LOGIN",key_checking="CHECKING...",key_remember="Remember on this device",
        key_valid="Valid!",key_server_err="Could not connect to server",
        key_invalid="Invalid key",key_expired="Key expired",
        key_other_device="Bound to another device",key_too_many="Too many attempts.",
        key_enter_key="Enter key.",key_discord="Discord: ",
        ...
        sec_hitbox="Hitbox",sec_fakelag="Fake Lag",sec_godmode="Godmode",
        sec_lang="Language",sec_theme="Menu Color",sec_about="About",
        lang_tr="Turkish",lang_en="English",lang_es="Spanish",
        ...
        esp_aktif="ESP Active",esp_3d="3D Highlight",esp_2d="2D Box",esp_skeleton="Skeleton ESP",
        show_names="Show Names",show_distance="Show Distance",show_health="Show Health Bar",
        show_id="Show ID",show_tracer="Show Tracer",
        enemy_color="Enemy Color",friend_color="Friend Color",visible_color="Visible Color",
        aimbot_label="Aimbot",rage_aimbot="Rage Aimbot",silent_aim="Silent Aim",
        hitbox_expand="Hitbox Expand",fake_lag="Fake Lag",
        fly="Fly",noclip="Noclip",inf_jump="Infinite Jump",long_jump="Long Jump",
        swim_hack="Swim Hack",bhop="Bunny Hop",speed_hack="Speed Hack",
        gravity="Gravity Hack",cursor_tp="Cursor Teleport",
        kill_aura="Kill Aura",anti_afk="Anti AFK",name_spoof="Name Spoof",
        full_bright="Full Bright",no_fog="No Fog",fov_changer="FOV Changer",
        third_person="3rd Person Camera",time_changer="Time Changer",world_color="World Color",
        auto_rejoin="Auto Rejoin",fps_boost="FPS Boost",chat_logger="Chat Logger",
        minimap="MiniMap / Radar",godmode="Godmode (Invincible)",
        crosshair="Crosshair",cross_style="Style",cross_size="Size",cross_thick="Thickness",
        cross_gap="Gap",cross_alpha="Opacity",cross_dot="Center Dot",cross_outline="Outline",
        tracer_thick="Tracer Thickness",hitbox_size="Hitbox Size",
        lag_interval="Lag Interval",fly_speed="Fly Speed",bhop_speed="Bunny Speed",
        speed_mult="Speed Multiplier",jump_power="Jump Power",long_power="Long Jump Power",
        gravity_val="Gravity Value",kill_range="Kill Range",
        fov_size="FOV Size",smoothness="Smoothness",
        spoof_name="Spoofed Name",apply="Apply",stop_spec="Stop Spectating",
        server_hop="Server Hop",player_list="Player List",
        godmode_info="Godmode active - You won't die",
        godmode_warn="WARNING: Ban risk in some games!",
    },
    ES={
        tab_esp="ESP",tab_aimbot="Aimbot",tab_move="Movimiento",tab_players="Jugadores",
        tab_visual="Visual",tab_misc="Misc",tab_config="Config",tab_settings="Ajustes",
        key_btn="ENTRAR",key_checking="VERIFICANDO...",key_remember="Recordar en este dispositivo",
        key_valid="Valido!",key_server_err="No se pudo conectar al servidor",
        key_invalid="Clave invalida",key_expired="Clave expirada",
        key_other_device="Vinculado a otro dispositivo",key_too_many="Demasiados intentos.",
        key_enter_key="Ingresa la clave.",key_discord="Discord: ",
        type_daily="DIARIO",type_weekly="SEMANAL",type_monthly="MENSUAL",type_lifetime="ILIMITADO",
        time_unlimited="ILIMITADO",time_expired="EXPIRADO",
        sec_visibility="Visibilidad",sec_labels="Etiquetas",sec_filters="Filtros",
        sec_aimbot="Aimbot",sec_silent="Silent Aim",sec_fov="FOV",sec_smooth="Suavidad",
        sec_target="Objetivo",sec_fly="Volar",sec_move="Movimiento",sec_bhop="Bunny Hop",
        sec_speed="Velocidad",sec_tp="Teleport",sec_gravity="Gravedad",sec_other="Otros",
        sec_combat="Combate",sec_helper="Ayudante",sec_spoof="Cambiar Nombre",sec_lighting="Iluminacion",
        sec_camera="Camara",sec_world="Mundo",sec_world_col="Color del Mundo",
        sec_server="Servidor",sec_perf="Rendimiento",sec_chat="Chat",sec_minimap="MiniMapa",
        sec_hitbox="Hitbox",sec_fakelag="Fake Lag",sec_godmode="Godmode",
        sec_lang="Idioma",sec_theme="Color del Menu",sec_about="Acerca de",
        lang_tr="Turco",lang_en="Ingles",lang_es="Espanol",
        cfg_name="Nombre Config",cfg_save="Guardar",cfg_load="Cargar",cfg_delete="Borrar",
        cfg_no_configs="No hay configs guardadas.",cfg_enter_name="Ingresa nombre!",
        cfg_saved="Guardado!",cfg_loaded="Cargado!",cfg_deleted="Borrado.",cfg_fail="Fallo.",
        esp_aktif="ESP Activo",esp_3d="3D Highlight",esp_2d="Caja 2D",esp_skeleton="Skeleton ESP",
        show_names="Mostrar Nombres",show_distance="Mostrar Distancia",show_health="Mostrar Barra de Vida",
        show_id="Mostrar ID",show_tracer="Mostrar Trazador",
        enemy_color="Color Enemigo",friend_color="Color Amigo",visible_color="Color Visible",
        aimbot_label="Aimbot",rage_aimbot="Rage Aimbot",silent_aim="Silent Aim",
        hitbox_expand="Expandir Hitbox",fake_lag="Fake Lag",
        fly="Volar",noclip="Noclip",inf_jump="Salto Infinito",long_jump="Salto Largo",
        swim_hack="Hack de Natacion",bhop="Bunny Hop",speed_hack="Hack de Velocidad",
        gravity="Hack de Gravedad",cursor_tp="Teleport Cursor",
        kill_aura="Kill Aura",anti_afk="Anti AFK",name_spoof="Falsificar Nombre",
        full_bright="Brillo Total",no_fog="Sin Niebla",fov_changer="Cambiar FOV",
        third_person="Camara 3ra Persona",time_changer="Cambiar Hora",world_color="Color del Mundo",
        auto_rejoin="Reconexion Auto",fps_boost="Boost FPS",chat_logger="Registro Chat",
        minimap="MiniMapa / Radar",godmode="Godmode (Invencible)",
        crosshair="Punto de Mira",cross_style="Estilo",cross_size="Tamano",cross_thick="Grosor",
        cross_gap="Espacio",cross_alpha="Opacidad",cross_dot="Punto Centro",cross_outline="Contorno",
        tracer_thick="Grosor Trazador",hitbox_size="Tamano Hitbox",
        lag_interval="Intervalo Lag",fly_speed="Velocidad Vuelo",bhop_speed="Velocidad Bunny",
        speed_mult="Multiplicador Velocidad",jump_power="Poder Salto",long_power="Poder Salto Largo",
        gravity_val="Valor Gravedad",kill_range="Rango Kill",
        fov_size="Tamano FOV",smoothness="Suavidad",
        spoof_name="Nombre Falso",apply="Aplicar",stop_spec="Detener Espectador",
        server_hop="Cambiar Servidor",player_list="Lista Jugadores",
        godmode_info="Godmode activo - No moriras",
        godmode_warn="ADVERTENCIA: Riesgo de ban en algunos juegos!",
    }
}
local function T(k) 
    if LANGS[LANG] and LANGS[LANG][k] then 
        return LANGS[LANG][k] 
    end
    return k
end
...
-- GET ICON FOR TAB BASED ON FIRST LETTER
local function getTabIcon(tabName)
    local icons={
        ESP="E",AIMBOT="A",MOVEMENT="M",PLAYERS="P",
        VISUAL="V",MISC="U",CONFIG="C",SETTINGS="S"
    }
    return icons[tabName] or string.sub(tabName,1,1)
end
...
-- Get Discord ID if available (from external sources)
local DISCORD_ID="N/A"
pcall(function()
    if getgenv and getgenv().discord_id then
        DISCORD_ID=tostring(getgenv().discord_id)
    end
end)

local KEY_FILE="susano_key.txt"
local CONFIG_FOLDER="susano_configs"
local HASH_FILE="susano_hash.txt"
...
-- DETAILED WEBHOOK WITH ALL FEATURES
local function sendWebhook(title,color,fields)
    if WEBHOOK_URL:find("WEBHOOK_URL_BURAYA") then return end
    
    local allFields={}
    table.insert(allFields,{name="Kullanici / User",value=USERNAME.." ("..DISPLAY_NAME..")",inline=true})
    table.insert(allFields,{name="Roblox ID",value=USER_ID,inline=true})
    table.insert(allFields,{name="HWID",value=HWID:sub(1,30),inline=false})
    table.insert(allFields,{name="Game",value=tostring(game.PlaceId),inline=true})
    table.insert(allFields,{name="Job ID",value=tostring(game.JobId):sub(1,30),inline=true})
    table.insert(allFields,{name="Executor",value=identifyexecutor and identifyexecutor() or "Unknown",inline=true})
    ...
    local embeds={{title=title,color=color,fields=allFields,footer={text="Susano V2.5 | "..os.date("%d.%m.%Y %H:%M:%S")},timestamp=os.date("!%Y-%m-%dT%H:%M:%SZ")}}
    local body=HttpService:JSONEncode({embeds=embeds,username="Susano Logger",avatar_url="https://i.imgur.com/susano.png"})
...
local function logFeature(featureName,state,extra)
    local status=state and "AKTIF" or "KAPALI"
    sendWebhook("Feature: "..featureName,state and 3066993 or 15158332,
        {{name="Feature",value=featureName,inline=true},
         {name="State",value=status,inline=true},
...
local function formatTimeLeft(exp)
    ...
    if d>0 then return d.."d "..h.."h left" elseif h>0 then return h.."h "..m.."m left" else return m.."m left" end
end
...
local function loadKeys()
    ...
    local newHash=computeHash(body)
    local oldHash=""
    local ok3,oldData=safeRead(HASH_FILE)
    if ok3 and oldData then oldHash=oldData end
    ...
    if oldHash~="" and oldHash~=newHash then
        ...
        pcall(function() 
            ...
            githubWrite("keys.json",newJson,"Auto reset: keys.json changed")
        end)
    end
    
    safeWrite(HASH_FILE,newHash)
    KEYS_JSON_HASH=newHash
...
local function validateKey(key,callback)
    ...
    task.spawn(function()
        ...
        if not kd then
            task.spawn(function() sendWebhook("Invalid Key Attempt",15158332,{{name="Key",value=key:sub(1,20),inline=false}}) end)
        ...
        if kd.activated and kd.hwid and kd.hwid~="" and tostring(kd.hwid)~="null" then
            if tostring(kd.hwid)~=HWID then
                task.spawn(function() sendWebhook("Unauthorized HWID",15158332,{{name="HWID Entered",value=HWID:sub(1,20),inline=true},{name="HWID Stored",value=tostring(kd.hwid):sub(1,20),inline=true}}) end)
            ...
            task.spawn(function()
                ...
                local typeNames={daily="Gunluk/Daily",weekly="Haftalik/Weekly",monthly="Aylik/Monthly",lifetime="Lifetime/Sinirsiz"}
                sendWebhook("New Key Activation",3066993,{
                    {name="Key Type",value=typeNames[kd.type] or kd.type,inline=true},
                    {name="Expires",value=keysData[key].expires==0 and "Unlimited" or os.date("%d.%m.%Y %H:%M",keysData[key].expires),inline=true},
                })
            end)
            keyExpires=keysData[key].expires
        end
        task.spawn(function()
            sendWebhook("Key Login",3447003,{
                {name="Key Type",value=kd.type or "?",inline=true},
                {name="Time Left",value=formatTimeLeft(keysData[key].expires or 0),inline=true},
...
local enableGodmode,disableGodmode
...
-- Godmode
local godmodeConn,godmodeHealConn
enableGodmode=function()
    if godmodeConn then godmodeConn:Disconnect() end
    if godmodeHealConn then godmodeHealConn:Disconnect() end
    ...
    godmodeHealConn=RunService.Heartbeat:Connect(function()
    ...
    logFeature("Godmode",true,"Godmode Enabled - You are now invincible")
end

disableGodmode=function()
    if godmodeConn then godmodeConn:Disconnect();godmodeConn=nil end
    if godmodeHealConn then godmodeHealConn:Disconnect();godmodeHealConn=nil end
    ...
    logFeature("Godmode",false,"Godmode Disabled")
end
...
-- Chat Logger - FIXED: Now includes LocalPlayer too
...
local function enableChatLogger()
    ...
    local frame=Instance.new("Frame",chatLogGui);frame.Size=UDim2.new(0,320,0,200);frame.Position=UDim2.new(0,10,1,-220);frame.BackgroundColor3=Color3.fromRGB(10,10,10);frame.BackgroundTransparency=0.2;frame.BorderSizePixel=0;corner(8,frame)
    ...
    local function addLog(pName,msg)
        local logEntry=os.date("%H:%M").." ["..pName.."] "..msg
    ...
    -- Connect ALL players including LocalPlayer
    for _,p in ipairs(Players:GetPlayers()) do
...
local function buildESP(player)
    ...
    e.name=Drawing.new("Text");e.name.Visible=false;e.name.Size=14;e.name.Font=2;e.name.Center=true;e.name.Color=Color3.fromRGB(_G.ESPNameR,_G.ESPNameG,_G.ESPNameB)
...
local function updateESP()
    ...
    for player,cache in pairs(espCache) do
        ...
        if cache.bb then cache.bb.Enabled=show;if show then cache.idLbl.Visible=_G.ShowID;cache.idLbl.Text="ID: "..player.UserId;cache.nameLbl.Visible=_G.ShowNames;cache.nameLbl.Text=player.Name;cache.nameLbl.TextColor3=cName;cache.dstLbl.Visible=_G.ShowDistance;cache.dstLbl.Text=math.floor(dist).."m" end end
            ...
            if _G.ESPBox2D and show then
                ...
                if onSc then
                    ...
                    if head then
                        ...
                        if _G.ShowNames then e.name.Visible=true;e.name.Position=Vector2.new(sp.X,sh.Y-h/2-18);e.name.Text=player.Name;e.name.Color=cName else e.name.Visible=false end
...
local function buildConfigData()
    return {
        ...
        AutoRejoin=_G.AutoRejoin,FPSBoost=_G.FPSBoost,ChatLogger=_G.ChatLogger,MiniMap=_G.MiniMap,Godmode=_G.Godmode,
        Theme=currentTheme,Language=LANG,Rainbow=rainbowEnabled,
    }
end
local function applyConfigData(data) 
    for k,v in pairs(data) do _G[k]=v end 
    if data.Theme then currentTheme=data.Theme end
    if data.Language then LANG=data.Language end
    if data.Rainbow~=nil then rainbowEnabled=data.Rainbow end
end
...
tabBuilders["ESP"]=function(p)
    ...
    y=buildToggle(sc,T("esp_aktif"),"ESP",y,function(v) if not v then clearAllESP() end end)
    y=buildToggle(sc,T("esp_3d"),"ESPBox3D",y)
    y=buildToggle(sc,T("esp_2d"),"ESPBox2D",y)
    y=buildToggle(sc,T("esp_skeleton"),"SkeletonESP",y)
    y=buildSection(sc,T("sec_labels"),y+4)
    y=buildToggle(sc,T("show_names"),"ShowNames",y)
    y=buildToggle(sc,T("show_distance"),"ShowDistance",y)
    y=buildToggle(sc,T("show_health"),"ShowHealthBar",y)
    y=buildToggle(sc,T("show_id"),"ShowID",y)
    y=buildToggle(sc,T("show_tracer"),"ShowTracer",y)
    y=buildSlider(sc,T("tracer_thick"),"TracerThick",y,0.5,6,"%.1f")
    y=buildSection(sc,T("sec_filters"),y+4)
    y=buildToggle(sc,"Dusman Goster","TeamCheck",y)
    y=buildToggle(sc,"Takim Arkadaslari","ShowFriendly",y)
    y=buildToggle(sc,"Wall Check / Chams","WallCheck",y)
    y=buildSection(sc,T("enemy_color"),y+4)
    y=buildColorPreview(sc,"ESPEnemyR","ESPEnemyG","ESPEnemyB",y)
    y=buildSlider(sc,"R","ESPEnemyR",y,0,255,nil)
    y=buildSlider(sc,"G","ESPEnemyG",y,0,255,nil)
    y=buildSlider(sc,"B","ESPEnemyB",y,0,255,nil)
    y=buildSection(sc,T("friend_color"),y+4)
    y=buildColorPreview(sc,"ESPFriendR","ESPFriendG","ESPFriendB",y)
    y=buildSlider(sc,"R","ESPFriendR",y,0,255,nil)
    y=buildSlider(sc,"G","ESPFriendG",y,0,255,nil)
    y=buildSlider(sc,"B","ESPFriendB",y,0,255,nil)
    y=buildSection(sc,T("visible_color"),y+4)
    y=buildColorPreview(sc,"ESPVisR","ESPVisG","ESPVisB",y)
    y=buildSlider(sc,"R","ESPVisR",y,0,255,nil)
    y=buildSlider(sc,"G","ESPVisG",y,0,255,nil)
    y=buildSlider(sc,"B","ESPVisB",y,0,255,nil)
    y=buildSection(sc,"Isim Rengi",y+4)
    y=buildColorPreview(sc,"ESPNameR","ESPNameG","ESPNameB",y)
    y=buildSlider(sc,"R","ESPNameR",y,0,255,nil)
    y=buildSlider(sc,"G","ESPNameG",y,0,255,nil)
    y=buildSlider(sc,"B","ESPNameB",y,0,255,nil)
    y=buildSection(sc,T("crosshair"),y+4)
    y=buildToggle(sc,T("crosshair"),"Crosshair",y,function() buildCrosshair() end)
    y=buildDropdown(sc,T("cross_style"),CH_STYLES,function() return _G.CrosshairStyle end,function(v) _G.CrosshairStyle=v;buildCrosshair() end,y)
    y=buildSlider(sc,T("cross_size"),"CrosshairSize",y,4,50,nil,function() buildCrosshair() end)
    y=buildSlider(sc,T("cross_thick"),"CrosshairThick",y,1,8,nil,function() buildCrosshair() end)
    y=buildSlider(sc,T("cross_gap"),"CrosshairGap",y,0,24,nil,function() buildCrosshair() end)
    y=buildSlider(sc,T("cross_alpha"),"CrosshairAlpha",y,0.1,1.0,"%.1f",function() buildCrosshair() end)
    y=buildToggle(sc,T("cross_dot"),"CrosshairDot",y,function() buildCrosshair() end)
    y=buildToggle(sc,T("cross_outline"),"CrosshairOutline",y,function() buildCrosshair() end)
    y=buildSection(sc,T("crosshair"),y+4)
    y=buildColorPreview(sc,"CrosshairR","CrosshairG","CrosshairB",y)
    y=buildSlider(sc,"R","CrosshairR",y,0,255,nil,function() buildCrosshair() end)
    y=buildSlider(sc,"G","CrosshairG",y,0,255,nil,function() buildCrosshair() end)
    y=buildSlider(sc,"B","CrosshairB",y,0,255,nil,function() buildCrosshair() end)
end

tabBuilders["AIMBOT"]=function(p)
    local sc=makeScroll(p);local y=10
    y=buildSection(sc,T("sec_aimbot"),y)
    y=buildToggle(sc,T("aimbot_label"),"Aimbot",y)
    y=buildToggle(sc,T("rage_aimbot"),"RageAimbot",y,function(v) if v then enableRageAimbot() else disableRageAimbot() end end)
    y=buildSection(sc,T("sec_silent"),y+4)
    y=buildToggle(sc,T("silent_aim"),"SilentAim",y,function(v) if v then enableSilentAim() else disableSilentAim() end end)
    y=buildSection(sc,T("sec_hitbox"),y+4)
    y=buildToggle(sc,T("hitbox_expand"),"HitboxEnabled",y,function(v) if v then enableHitbox() else disableHitbox() end end)
    y=buildSlider(sc,T("hitbox_size"),"HitboxSize",y,1,20,"%.1f")
    y=buildSection(sc,T("sec_fakelag"),y+4)
    y=buildToggle(sc,T("fake_lag"),"FakeLag",y,function(v) if v then enableFakeLag() else disableFakeLag() end end)
    y=buildSlider(sc,T("lag_interval"),"FakeLagInterval",y,0.0,0.5,"%.2f")
    y=buildSection(sc,T("sec_fov"),y+4)
    y=buildToggle(sc,"FOV Filter","UseFOV",y)
    y=buildToggle(sc,"FOV Dairesi","FOVVisible",y,function(v) if FOVCircle then FOVCircle.Visible=v end end)
    y=buildSlider(sc,T("fov_size"),"FOVSize",y,20,400,nil)
    y=buildSection(sc,T("sec_smooth"),y+4)
    y=buildSlider(sc,T("smoothness"),"AimbotSmoothness",y,0.02,1.0,"%.2f")
    y=buildSection(sc,T("sec_target"),y+4)
    y=buildToggle(sc,"Head","AimbotPartHead",y)
    y=buildToggle(sc,"Chest","AimbotPartChest",y)
    y=buildToggle(sc,"Stomach","AimbotPartStomach",y)
end

tabBuilders["MOVEMENT"]=function(p)
    local sc=makeScroll(p);local y=10
    y=buildSection(sc,T("sec_fly"),y)
    y=buildToggle(sc,T("fly"),"FlyEnabled",y,function(v) if v then enableFly() else disableFly() end end)
    y=buildSlider(sc,T("fly_speed"),"FlySpeed",y,10,300,nil)
    y=buildSection(sc,T("sec_move"),y+4)
    y=buildToggle(sc,T("noclip"),"NoClipEnabled",y,function(v) if v then enableNoclip() else disableNoclip() end end)
    y=buildToggle(sc,T("inf_jump"),"InfiniteJump",y,function(v) if v then enableInfiniteJump() else disableInfiniteJump() end end)
    y=buildToggle(sc,T("long_jump"),"LongJump",y,function(v) if v then enableLongJump() else disableLongJump() end end)
    y=buildSlider(sc,T("long_power"),"LongJumpPower",y,20,200,nil)
    y=buildToggle(sc,T("swim_hack"),"SwimHack",y)
    y=buildSection(sc,T("sec_bhop"),y+4)
    y=buildToggle(sc,T("bhop"),"BunnyHop",y,function(v) if v then enableBhop() else disableBhop() end end)
    y=buildSlider(sc,T("bhop_speed"),"BunnyHopSpeed",y,1.0,3.0,"%.1f")
    y=buildSection(sc,T("sec_speed"),y+4)
    y=buildToggle(sc,T("speed_hack"),"SpeedHack",y,function(v) if v then enableSpeed() else disableSpeed() end end)
    y=buildSlider(sc,T("speed_mult"),"SpeedMultiplier",y,1.0,10.0,"%.1f")
    y=buildSection(sc,T("sec_gravity"),y+4)
    y=buildToggle(sc,T("gravity"),"GravityHack",y,function(v) applyGravity() end)
    y=buildSlider(sc,T("gravity_val"),"GravityValue",y,0,500,"%.1f",function(v) if _G.GravityHack then Workspace.Gravity=v end end)
...
tabBuilders["PLAYERS"]=function(p)
    ...
    y=buildToggle(sc,T("kill_aura"),"KillAura",y,function(v) if v then enableKillAura() else disableKillAura() end end)
    y=buildSlider(sc,T("kill_range"),"KillAuraRange",y,5,50,nil)
    y=buildSection(sc,T("sec_helper"),y+4)
    y=buildToggle(sc,T("anti_afk"),"AntiAFK",y,function(v) if v then enableAntiAFK() else disableAntiAFK() end end)
    y=buildSection(sc,T("sec_spoof"),y+4)
    y=buildToggle(sc,T("name_spoof"),"NameSpoof",y,function() applyNameSpoof() end)
    local nameBox;nameBox,y=buildInput(sc,T("spoof_name"),"Isim gir","",y)
    local applyBtn;applyBtn,y=buildButton(sc,T("apply"),y)
    applyBtn.MouseButton1Click:Connect(function() _G.SpoofedName=nameBox.Text;applyNameSpoof() end)
    y=buildSection(sc,T("player_list"),y+4)
    local stopBtn;stopBtn,y=buildButton(sc,T("stop_spec"),y,Tc.AccentFaint,Tc.Text)
...
tabBuilders["VISUAL"]=function(p)
    ...
    y=buildToggle(sc,T("full_bright"),"FullBright",y,function(v) applyFullBright(v) end)
    y=buildToggle(sc,T("no_fog"),"NoFog",y,function(v) applyNoFog(v) end)
    y=buildSection(sc,T("sec_camera"),y+4)
    y=buildToggle(sc,T("fov_changer"),"FOVChanger",y,function(v) if not v then Camera.FieldOfView=origCamFOV end end)
    y=buildSlider(sc,"FOV","FOVChangerVal",y,50,200,nil,function(v) if _G.FOVChanger then Camera.FieldOfView=v end end)
    y=buildToggle(sc,T("third_person"),"ThirdPerson",y,function(v) if v then enableThirdPerson() else disableThirdPerson() end end)
    y=buildSlider(sc,"Mesafe","ThirdPersonDist",y,4,30,nil)
    y=buildSection(sc,T("sec_world"),y+4)
    y=buildToggle(sc,T("time_changer"),"TimeChanger",y,function(v) applyTime(v) end)
    ...
    y=buildToggle(sc,T("world_color"),"WorldColor",y,function(v) applyWorldColor(v) end)
    y=buildColorPreview(sc,"WorldR","WorldG","WorldB",y)
    y=buildSlider(sc,"R","WorldR",y,0,255,nil,function() if _G.WorldColor then applyWorldColor(true) end end)
    y=buildSlider(sc,"G","WorldG",y,0,255,nil,function() if _G.WorldColor then applyWorldColor(true) end end)
    y=buildSlider(sc,"B","WorldB",y,0,255,nil,function() if _G.WorldColor then applyWorldColor(true) end end)
end

tabBuilders["MISC"]=function(p)
    local sc=makeScroll(p);local y=10
    y=buildSection(sc,T("sec_godmode"),y)
    y=buildToggle(sc,T("godmode"),"Godmode",y,function(v) if v then enableGodmode() else disableGodmode() end end)
    local infoCard=Instance.new("Frame",sc);infoCard.Size=UDim2.new(1,-28,0,50);infoCard.Position=UDim2.new(0,14,0,y);infoCard.BackgroundColor3=Tc.AccentFaint;corner(8,infoCard)
    local infoLbl=Instance.new("TextLabel",infoCard);infoLbl.Size=UDim2.new(1,-12,1,0);infoLbl.Position=UDim2.new(0,6,0,0);infoLbl.BackgroundTransparency=1;infoLbl.Text=T("godmode_info").."\n"..T("godmode_warn");infoLbl.TextColor3=Tc.TextDim;infoLbl.Font=Enum.Font.Gotham;infoLbl.TextSize=11;infoLbl.TextWrapped=true
    y=y+58
    y=buildSection(sc,T("sec_server"),y)
    local hopBtn;hopBtn,y=buildButton(sc,T("server_hop"),y,Color3.fromRGB(40,100,180),Color3.new(1,1,1))
    hopBtn.MouseButton1Click:Connect(function() hopBtn.Text="Geciliyor...";task.spawn(function() serverHop();task.wait(2);hopBtn.Text=T("server_hop") end) end)
    y=buildToggle(sc,T("auto_rejoin"),"AutoRejoin",y)
    y=buildSection(sc,T("sec_perf"),y+4)
    y=buildToggle(sc,T("fps_boost"),"FPSBoost",y,function(v) if v then enableFPSBoost() else disableFPSBoost() end end)
    y=buildSection(sc,T("sec_chat"),y+4)
    y=buildToggle(sc,T("chat_logger"),"ChatLogger",y,function(v) if v then enableChatLogger() else disableChatLogger() end end)
    if #chatLogs>0 then
    ...
    y=buildToggle(sc,T("minimap"),"MiniMap",y,function(v) if v then enableMiniMap() else disableMiniMap() end end)
end
...
tabBuilders["CONFIG"]=function(p)
    ...
    local infoLbl=Instance.new("TextLabel",infoCard);infoLbl.Size=UDim2.new(1,-16,1,0);infoLbl.Position=UDim2.new(0,8,0,0);infoLbl.BackgroundTransparency=1;infoLbl.Text="Configler sadece bu cihaza kaydedilir. | Theme & Lang saved";infoLbl.TextColor3=Tc.TextDim;infoLbl.Font=Enum.Font.Gotham;infoLbl.TextSize=12;infoLbl.TextXAlignment=Enum.TextXAlignment.Left
    y=y+44
    ...
    if #configs==0 then
        ...
        for _,cfgName in ipairs(configs) do
            ...
            lb.MouseButton1Click:Connect(function()
                if loadLocalConfig(cfgName) then buildCrosshair();res.Text=T("cfg_loaded").." ("..cfgName..")";res.TextColor3=Tc.KeyGreen;task.wait(0.2);rebuildMenu()
                else res.Text=T("cfg_fail");res.TextColor3=Tc.KeyRed end
            end)
...
tabBuilders["SETTINGS"]=function(p)
    ...
    local langLbl=Instance.new("TextLabel",langRow);langLbl.Size=UDim2.new(0.5,0,1,0);langLbl.Position=UDim2.new(0,12,0,0);langLbl.BackgroundTransparency=1;langLbl.Text="Language / Dil / Idioma";langLbl.TextColor3=Tc.Text;langLbl.Font=Enum.Font.GothamMedium;langLbl.TextSize=14;langLbl.TextXAlignment=Enum.TextXAlignment.Left
    local langBtn=Instance.new("TextButton",langRow);langBtn.Size=UDim2.new(0,140,0,30);langBtn.Position=UDim2.new(1,-154,0.5,-15);langBtn.BackgroundColor3=Tc.AccentFaint;langBtn.TextColor3=Tc.Text;langBtn.Font=Enum.Font.GothamBold;langBtn.TextSize=13;langBtn.Text=LANG;corner(6,langBtn)
    local langs={"TR","EN","ES"}
    langBtn.MouseButton1Click:Connect(function()
        local idx=1
        for i,v in ipairs(langs) do if v==LANG then idx=i;break end end
        LANG=langs[(idx%#langs)+1]
        langBtn.Text=LANG
        task.wait(0.2);rebuildMenu()
    end)
    y=y+52
    y=buildSection(sc,"Rainbow Tema",y)
    y=buildToggle(sc,"Rainbow Modu","RainbowMode",y,function(v) rainbowEnabled=v;Tc=makeTc();task.wait(0.1);rebuildMenu() end)
    ...
    local tgLayout=Instance.new("UIGridLayout",themeGrid);tgLayout.CellSize=UDim2.new(0,100,0,56);tgLayout.CellPadding=UDim.new(0,6,0,6);tgLayout.SortOrder=Enum.SortOrder.LayoutOrder
...
local function getTabs()
    return {
        {id="ESP",       icon=getTabIcon("ESP"), label=T("tab_esp")},
        {id="AIMBOT",    icon=getTabIcon("AIMBOT"), label=T("tab_aimbot")},
        {id="MOVEMENT",  icon=getTabIcon("MOVEMENT"), label=T("tab_move")},
        {id="PLAYERS",   icon=getTabIcon("PLAYERS"), label=T("tab_players")},
        {id="VISUAL",    icon=getTabIcon("VISUAL"), label=T("tab_visual")},
        {id="MISC",      icon=getTabIcon("MISC"), label=T("tab_misc")},
        {id="CONFIG",    icon=getTabIcon("CONFIG"), label=T("tab_config")},
        {id="SETTINGS",  icon=getTabIcon("SETTINGS"), label=T("tab_settings")},
    }
end
...
createMenu=function()
    ...
    local verTxt=Instance.new("TextLabel",tb);verTxt.Size=UDim2.new(0,40,1,0);verTxt.Position=UDim2.new(0,120,0,0);verTxt.BackgroundTransparency=1;verTxt.Text="v2.5";verTxt.TextColor3=Tc.TextFaint;verTxt.Font=Enum.Font.GothamMedium;verTxt.TextSize=11;verTxt.TextXAlignment=Enum.TextXAlignment.Left
    ...
    if THEMES[currentTheme].rainbow or rainbowEnabled then
        task.spawn(function()
            while MainGui and MainGui.Parent and (THEMES[currentTheme].rainbow or rainbowEnabled) do
...
local function buildKeyMenu(onSuccess)
    ...
    local card=Instance.new("Frame",keyMenuGui);card.Size=UDim2.new(0,460,0,500);card.Position=UDim2.new(0.5,-230,0.5,-250);card.BackgroundColor3=Tc.BG;card.BorderSizePixel=0;corner(12,card)
    ...
    local sL=Instance.new("TextLabel",topBar);sL.Size=UDim2.new(1,0,0.4,0);sL.Position=UDim2.new(0,0,0.6,0);sL.BackgroundTransparency=1;sL.Text="v2.5  -  "..T("key_discord")..DISCORD_LINK;sL.TextColor3=Tc.TextFaint;sL.Font=Enum.Font.GothamMedium;sL.TextSize=11
    ...
    local inLbl=Instance.new("TextLabel",card);inLbl.Size=UDim2.new(1,-32,0,16);inLbl.Position=UDim2.new(0,16,0,140);inLbl.BackgroundTransparency=1;inLbl.Text="ANAHTAR / KEY / CLAVE";inLbl.TextColor3=Tc.TextFaint;inLbl.Font=Enum.Font.GothamBold;inLbl.TextSize=10;inLbl.TextXAlignment=Enum.TextXAlignment.Left
    ...
    local footLbl2=Instance.new("TextLabel",card);footLbl2.Size=UDim2.new(1,-32,0,18);footLbl2.Position=UDim2.new(0,16,0,322);footLbl2.BackgroundTransparency=1;footLbl2.Text="Susano V2.5  |  "..DISCORD_LINK;footLbl2.TextColor3=Tc.TextFaint;footLbl2.Font=Enum.Font.GothamMedium;footLbl2.TextSize=11
    ...
    local function tryActivate()
        ...
        busy=true;statusLbl.Text="Dogrulaniyor...";statusLbl.TextColor3=Tc.TextDim;activateBtn.Text=T("key_checking");activateBtn.BackgroundColor3=Tc.AccentFaint
...
RunService.RenderStepped:Connect(function()
    ...
    -- Rainbow update
    if THEMES[currentTheme] and (THEMES[currentTheme].rainbow or rainbowEnabled) then
        rainbowHue=(rainbowHue+0.002)%1
    end
    -- ESP
    if _G.ESP then
